...
export default function Testimonial() {
  const testimonials = [
    {
      ...
      testimonial:
        "Exceptional service and attention to detail. Everything was handled professionally and efficiently from start to finish!",
    },
    {
      name: "Liam Johnson",
  ...
  return (
    <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
      <Title
        title="What Ouur Customers Say"
        subTitle="Discover why discerning travelers choose StayVenture for their luxury accmmodations around the world"
      />
